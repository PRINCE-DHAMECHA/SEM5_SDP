...
void main(List<String> arguments) {
  ...
  'pie']; // Here l is the list and is of type string
  ...
  */
  ...
  const desserts = [
    ...
    'Namra',
    'Aditys'
  ]; //This is same as , final desserts = const['Prince','Namra','Aditya'];
  ...
  */
  ...
  // Tear-off property
  drinks.forEach(
      print); // since the input of print is the same as the output of the forEach function, Dart allows you to rephrase that.
  */
  ...
  */
  ...
  var numbers = [1, 2, 3, 4];
  final doubleVal = numbers.map((val) => val + val);
  print(doubleVal);
  ...
  final ans = numbers.fold(0, (int sum, val) => sum + val);
  print(ans);
  ...
  final dReversed = desserts1.reversed;
  print(desserts1);
  print(dReversed);
...
//   // Challenge 3:
//   User user1 = User(1, 'Prince');
//   User user2 = User(2, 'Namra');
//   User user3 = User(3, 'Aditya');

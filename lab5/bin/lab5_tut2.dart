...
// 2 types of class: 1.Abstract and 2.Concrete class
...
// The classes and subclasses you created in the last section were concrete classes. It's not that they're made of cement; it just means that you can make actual objects out of them. : The whole Flutter framework is organized around That's in contrast to abstract classes, from which you can't make objects.
// Abstract class
...
void main(List<String> arguments) {
  ...
  final Prince = Student("Prince", "Suthar");
  final jessie = SchoolBandMember('Jessie', 'Jones');
  final marty = StudentAthlete('Marty', 'McFly');
  print(jon.fullName);
  print(Prince.fullName);
  final historyGrade = Grade.B;
  jon.grades.add(historyGrade);
  final students = [Prince, jessie, marty];

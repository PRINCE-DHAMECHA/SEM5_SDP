...
bool isPositive(int? anInt) {
  if (anInt == null) {
    return false;
  }
  return !anInt.isNegative;
}
...
void main(List<String> arguments) {
  ...
  */
  ...
  int num =
      15!; //It tells that right hand side value is not null and program will crash if it will be null at runtime

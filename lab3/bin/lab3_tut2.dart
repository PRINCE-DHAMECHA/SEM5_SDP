...
Function applymul(num mul) {
  return (num value) {return value * mul;};
}
*/
/*
//Closures and scope
...
int main() {
  ...
  /*
    //Naming parameters
    withinTolerance(75, min: 70, max: 80) // true
  ...
  /*
    //Assigning functions to variables
     ...
     String greeting = 'Hey';
     bool isHungry = true;
     Function multiply = (int a, int b) {   //here anonymous function will be assigned to multiply variable and its type is function.
     return a * b;
     };
  ...
  /*
   //Using anonymous functions
    ...
    print(multiply(50,16));
    */
  /*
    //Returning a function
    final double1 = applymul(2);//this will return function which will be assigned to triple ,so you can use triple to call it.
    print(double1(15));//20
    */
  /*
  ...
  /*
    ...
    Function applymul(num mul){
      return (num value)=>value*mul;
    }
    Function a=applymul(3);
    print(a(2));//6
